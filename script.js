...
const indicatorColor = grid
  .querySelectorAll(".row")[0]
  .querySelectorAll(".indicator")[0].style.backgroundColor;
...
function updateGrid() {
  const rowCells = grid
    ...
    [currentRow].querySelectorAll(".cell");
...
function checkGuess() {
  const rowIndicators = grid
    .querySelectorAll(".row")
    [currentRow].querySelectorAll(".indicator");
...
function handleRestart() {
  ...
  grid
    ...
    .forEach((indicator) => (indicator.style.backgroundColor = indicatorColor));
